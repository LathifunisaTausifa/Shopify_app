        ...
        <div data-aos="zoom-out">
            <Slider {...settings} >
              {TestimonialData.map((data)=> (
                ...
                shadow-lg rounded-lg py-8 px-6 mx-4 bg-primary/10 dark:bg-gray-800 relative'>
                <div className='mb-4'>
                ...
                <p className='text-xs text-gray-500'>{data.text}</p>
                    <h1 className='text-xl font-bold text-black/80  dark:text-gray-400'>{data.name}</h1>
                </div>
                </div>
                <p className='absolute font-serif text-9xl top-0 right-0 text-black/20'>,,</p>
                </div>
                </div>
              ))}
            </Slider>
